...
import Chorus from '../../assets/svgs/chorus.svg?react'
...
export function EffectsPanel() {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'stretch', height: '100%' }}>
      ...
      <EffectCard label="CHORUS" design={<Chorus/>} enabled={patch.chorusEnabled} onToggle={() => dispatch({ type: 'SET_CHORUS', enabled: !patch.chorusEnabled, depth: patch.chorusDepth, speed: patch.chorusSpeed, width: patch.chorusWidth, hpfCutoff: patch.chorusHpfCutoff, delayMs: patch.chorusDelayMs, reverbSend: patch.chorusReverbSend })} index={1}><ChorusControls /></EffectCard>
